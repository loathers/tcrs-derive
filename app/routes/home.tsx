...
export default function Home({ loaderData }: Route.ComponentProps) {
	...
	// revalidator changes identity as it runs, so depending on it would re-enter
	// this effect off the back of its own revalidate.
	// biome-ignore lint/correctness/useExhaustiveDependencies: keyed on the runId transition alone
	useEffect(() => {
